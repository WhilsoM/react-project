...
export const Footer = () => {
  ...
  const validateEmail = (email: string) => email.length > 0 && email.includes('@')
      ...
      <div className='container'>
        <div className={s.footer__wrapper}>
          <div className={s.footer__row_one}>
            ...
            <p className={s.footer__desc}>Путеводитель по городу Санкт-Петербург.</p>
            ...
            <form action='#'>
              <input
                ...
                value={inpValue}
              />
              <button onClick={(e) => mailSend(e)} className={`btn ${btnValue === 'отправлено! 🎉' ? 'success' : ''}`}>
                {btnValue}
              </button>
            </form>
          </div>
